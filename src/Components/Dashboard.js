  ...
  return (
    <div className="flex h-screen justify-center items-center">
      <div className="w-auto h-auto">
        ...
        <div className="border rounded-lg overflow-hidden m-0">
          <table>
            <thead>
              <tr className="bg-[#F4F0FF] text-black font-Inter text-sm font-semibold h-[41px]" >
                <th className="w-[144.6px] pr-20">Name</th>
                <th className="w-[144.6px] pr-20">Roll No</th>
                <th className="w-[144.6px] pr-20">Address</th>
                <th className="w-[144.6px] pr-20" >Institute</th>
                <th className="w-[144.6px] pr-20">Course</th>
              </tr>
            </thead>
            <tbody>
              <tr className=" h-[92px] text-sm" >
                <td className="pr-20">Aarav</td>
                ...
                <td className=""><div className="w-[144.6px] flex flex-col ml-5"><div className="text-left">Bachelors of</div><div className="text-left">Technology</div></div></td>
              </tr>
              <tr className="h-[109px] text-sm border-t border-[#EEEAF9]">
                <td className="pr-20" >Dhruv</td>
                ...
                <td className=""><div className="w-[144.6px] flex flex-col ml-5"><div className="text-left">Masters of Business</div><div className="text-left">Administration</div></div></td>
              </tr>
              <tr className="h-[109px] text-sm border-t border-[#EEEAF9]">
                <td className="pr-20" >Sahil</td>
                ...
                <td className=""><div className="w-[144.6px] flex flex-col ml-5"><div className="text-left">Bachelor of Unani</div><div className="text-left">Medicine and</div><div className="text-left">Surgery</div></div></td>
              </tr>
              <tr className="h-[51px] text-sm border-t border-[#EEEAF9]" >
                <td></td>
                <td></td>
                <td></td>
                <td></td>
